...
function calculateTotal(luckyNum, total) {
    ...
    console.log(calculateTotal(luckyNumber, 105));
    console.log(calculateTotal(luckyNumber, 115));
    console.log(calculateTotal(luckyNumber, 130));
    console.log(calculateTotal(luckyNumber, 140));
    console.log(calculateTotal(luckyNumber, 150));
    /**
     * TODO:
    ...
    var userTotal = (prompt('message What is your color today?'))
    alert("Your lucky number was:" + analyzeColor(userTotal))
